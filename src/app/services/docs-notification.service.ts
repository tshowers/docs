 ...
 * a plain observable list any component can render directly. Ported from
 * web-products/network's NetworkNotificationService, renamed for this app.
 */
@Injectable( { providedIn: 'root' } )
export class DocsNotificationService {
  private nextId = 1;
