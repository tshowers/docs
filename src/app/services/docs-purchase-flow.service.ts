...
import { DocsEntitlementService } from './docs-entitlement.service';
 ...
 * analytics, not core to completing a purchase. Mirrors
 * web-products/network's NetworkPurchaseFlowService, shared here by both
 * the Docs and Knowledge purchase flows.
 */
@Injectable( {
  providedIn: 'root'
} )
export class DocsPurchaseFlowService {
  constructor ( private entitlementService: DocsEntitlementService ) {}
